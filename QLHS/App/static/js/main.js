...
// Chỉ cho phép nhập ký tự chữ cho ô tên
    document.getElementById('fullName').addEventListener('input', function() {
        this.value = this.value.replace(/[^a-zA-ZÀ-ỹ\s]/g, '');
    });

    // Chỉ cho phép nhập số cho ô số điện thoại
...
//    const newSemesterInput = document.getElementById('new-semester');
//    const yearInput = document.getElementById('year-input');
//    const yearLabel = document.querySelector('label[for="year-input"]'); // Lấy label cho năm học
//
//
//    // Hàm để nạp kỳ học từ cơ sở dữ liệu
//    function loadSemesters() {
//        fetch('/api/semesters') // Endpoint để lấy dữ liệu kỳ học
//            .then(response => response.json())
//            .then(data => {
//                data.forEach(semester => {
//                    const option = document.createElement('option');
//                    option.value = semester.maHocKy;
//                    option.text = `${semester.tenHocKy} (${semester.namHoc})`; // Định dạng tên kỳ học
//                    semesterSelect.appendChild(option);
//                });
//            });
//    }
//
//    // Gọi hàm nạp kỳ học khi tải trang
//    loadSemesters();
//
//    // Xử lý sự kiện khi chọn kỳ học
//    semesterSelect.addEventListener('change', function() {
//        if (this.value) {
//            // Nếu có lựa chọn, không cho phép nhập liệu
//            newSemesterInput.style.display = 'none'; // Ẩn ô nhập
//            yearInput.style.display = 'none'; // Ẩn ô nhập
//            yearLabel.style.display = 'none'; // Ẩn label năm học
//
////            // Cập nhật thông tin vào các thẻ label
////            const selectedOption = this.options[this.selectedIndex];
////            const semesterInfo = selectedOption.text.split(' (');
////            const semesterName = semesterInfo[0];
////            const year = semesterInfo[1].replace(')', ''); // Lấy năm học
////
////            // Hiển thị thông tin
////            newSemesterInput.value = semesterName;
////            yearInput.value = year;
//        } else {
//            // Nếu không có lựa chọn, cho phép nhập liệu
//            newSemesterInput.style.display = 'block'; // Hiện ô nhập
//            yearInput.style.display = 'block'; // Hiện ô nhập
//            yearLabel.style.display = 'block'; // Hiện label năm học
//        }
//    });
//});
//
